 ...
 */
@Suppress("warnings")
open class _LtreeConsistent :
    AbstractRoutine<Boolean>("_ltree_consistent", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
         ...
         */
        val _2: Parameter<Array<org.jooq.postgres.extensions.types.Ltree?>?> = Internal.createParameter(
            "_2",
        ...
        @Deprecated(message = "Unknown data type. If this is a qualified, user-defined type, it may have been excluded from code generation. If this is a built-in type, you can define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
        val _5: Parameter<Any?> = Internal.createParameter(
            "_5",
            DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""),
            false,
            true
