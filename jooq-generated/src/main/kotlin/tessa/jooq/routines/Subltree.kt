 ...
 */
@Suppress("warnings")
open class Subltree : AbstractRoutine<Ltree>("subltree", Public.PUBLIC, DSL.comment(""), DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), LtreeBinding()) {
    companion object {
    ...
    init {
        returnParameter = Subltree.RETURN_VALUE
        addInParameter(Subltree._1)
        addInParameter(Subltree._2)
        addInParameter(Subltree._3)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Ltree?): Unit = setValue(Subltree._1, value)
    ...
    fun set__1(field: Field<Ltree?>): Unit {
        setField(Subltree._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Subltree._2, value)
    ...
    fun set__2(field: Field<Int?>): Unit {
        setField(Subltree._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Int?): Unit = setValue(Subltree._3, value)
