 ...
 */
@Suppress("warnings")
open class LtreeRecv : AbstractRoutine<Ltree>("ltree_recv", Public.PUBLIC, DSL.comment(""), DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), LtreeBinding()) {
    companion object {
    ...
    init {
        returnParameter = LtreeRecv.RETURN_VALUE
        addInParameter(LtreeRecv._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(LtreeRecv._1, value)
