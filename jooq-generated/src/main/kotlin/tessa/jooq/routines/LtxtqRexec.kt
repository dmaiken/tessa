 ...
 */
@Suppress("warnings")
open class LtxtqRexec : AbstractRoutine<Boolean>("ltxtq_rexec", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = LtxtqRexec.RETURN_VALUE
        addInParameter(LtxtqRexec._1)
        addInParameter(LtxtqRexec._2)
    }
