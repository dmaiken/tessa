 ...
 */
@Suppress("warnings")
open class Ltreeparentsel : AbstractRoutine<Double>("ltreeparentsel", Public.PUBLIC, DSL.comment(""), SQLDataType.DOUBLE) {
    companion object {
    ...
    init {
        returnParameter = Ltreeparentsel.RETURN_VALUE
        addInParameter(Ltreeparentsel._1)
        addInParameter(Ltreeparentsel._2)
        addInParameter(Ltreeparentsel._3)
        addInParameter(Ltreeparentsel._4)
    }
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(Ltreeparentsel._1, field)
    }
    ...
    fun set__2(field: Field<Long?>): Unit {
        setField(Ltreeparentsel._2, field)
    }
    ...
    fun set__3(field: Field<Any?>): Unit {
        setField(Ltreeparentsel._3, field)
    }
    ...
    fun set__4(field: Field<Int?>): Unit {
        setField(Ltreeparentsel._4, field)
    }
}
