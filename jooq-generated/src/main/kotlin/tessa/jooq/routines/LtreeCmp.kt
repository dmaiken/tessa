 ...
 */
@Suppress("warnings")
open class LtreeCmp : AbstractRoutine<Int>("ltree_cmp", Public.PUBLIC, DSL.comment(""), SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = LtreeCmp.RETURN_VALUE
        addInParameter(LtreeCmp._1)
        addInParameter(LtreeCmp._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Ltree?): Unit = setValue(LtreeCmp._1, value)
    ...
    fun set__1(field: Field<Ltree?>): Unit {
        setField(LtreeCmp._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Ltree?): Unit = setValue(LtreeCmp._2, value)
