 ...
 */
@Suppress("warnings")
open class LtreeGe : AbstractRoutine<Boolean>("ltree_ge", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = LtreeGe.RETURN_VALUE
        addInParameter(LtreeGe._1)
        addInParameter(LtreeGe._2)
    }
