 ...
 */
@Suppress("warnings")
open class LtreeSend : AbstractRoutine<ByteArray>("ltree_send", Public.PUBLIC, DSL.comment(""), SQLDataType.BLOB) {
    companion object {
    ...
    init {
        returnParameter = LtreeSend.RETURN_VALUE
        addInParameter(LtreeSend._1)
    }
