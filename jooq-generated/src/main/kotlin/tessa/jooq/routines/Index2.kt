 ...
 */
@Suppress("warnings")
open class Index2 : AbstractRoutine<Int>("index", Public.PUBLIC, DSL.comment(""), SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = Index2.RETURN_VALUE
        addInParameter(Index2._1)
        addInParameter(Index2._2)
        addInParameter(Index2._3)
        setOverloaded(true)
    }
