 ...
 */
@Suppress("warnings")
open class LtreeConsistent :
    AbstractRoutine<Boolean>("ltree_consistent", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = LtreeConsistent.RETURN_VALUE
        addInParameter(LtreeConsistent._1)
        addInParameter(LtreeConsistent._2)
        addInParameter(LtreeConsistent._3)
        addInParameter(LtreeConsistent._4)
        addInParameter(LtreeConsistent._5)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(LtreeConsistent._1, value)
    ...
    fun set__1(field: Field<Any?>): Unit {
        setField(LtreeConsistent._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Ltree?): Unit = setValue(LtreeConsistent._2, value)
    ...
    fun set__2(field: Field<Ltree?>): Unit {
        setField(LtreeConsistent._2, field)
    }

    /**
     * Set the <code>_3</code> parameter IN value to the routine
     */
    fun set__3(value: Short?): Unit = setValue(LtreeConsistent._3, value)
    ...
    fun set__3(field: Field<Short?>): Unit {
        setField(LtreeConsistent._3, field)
    }

    /**
     * Set the <code>_4</code> parameter IN value to the routine
     */
    fun set__4(value: Long?): Unit = setValue(LtreeConsistent._4, value)
    ...
    fun set__4(field: Field<Long?>): Unit {
        setField(LtreeConsistent._4, field)
    }

    /**
     * Set the <code>_5</code> parameter IN value to the routine
     */
    fun set__5(value: Any?): Unit = setValue(LtreeConsistent._5, value)
    ...
    fun set__5(field: Field<Any?>): Unit {
        setField(LtreeConsistent._5, field)
    }
}
