 ...
 */
@Suppress("warnings")
open class LtreeRisparent : AbstractRoutine<Boolean>("ltree_risparent", Public.PUBLIC, DSL.comment(""), SQLDataType.BOOLEAN) {
    companion object {
    ...
    init {
        returnParameter = LtreeRisparent.RETURN_VALUE
        addInParameter(LtreeRisparent._1)
        addInParameter(LtreeRisparent._2)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Ltree?): Unit = setValue(LtreeRisparent._1, value)
    ...
    fun set__1(field: Field<Ltree?>): Unit {
        setField(LtreeRisparent._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Ltree?): Unit = setValue(LtreeRisparent._2, value)
    ...
    fun set__2(field: Field<Ltree?>): Unit {
        setField(LtreeRisparent._2, field)
    }
}
