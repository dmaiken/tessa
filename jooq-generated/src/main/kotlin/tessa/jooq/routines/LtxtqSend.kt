 ...
 */
@Suppress("warnings")
open class LtxtqSend : AbstractRoutine<ByteArray>("ltxtq_send", Public.PUBLIC, DSL.comment(""), SQLDataType.BLOB) {
    companion object {
    ...
    init {
        returnParameter = LtxtqSend.RETURN_VALUE
        addInParameter(LtxtqSend._1)
    }
