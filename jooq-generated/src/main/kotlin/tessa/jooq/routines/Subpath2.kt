 ...
 */
@Suppress("warnings")
open class Subpath2 : AbstractRoutine<Ltree>("subpath", Public.PUBLIC, DSL.comment(""), DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), LtreeBinding()) {
    companion object {
    ...
    init {
        returnParameter = Subpath2.RETURN_VALUE
        addInParameter(Subpath2._1)
        addInParameter(Subpath2._2)
        setOverloaded(true)
    }
     ...
     */
    fun set__1(value: Ltree?): Unit = setValue(Subpath2._1, value)
    ...
    fun set__1(field: Field<Ltree?>): Unit {
        setField(Subpath2._1, field)
    }

    /**
     * Set the <code>_2</code> parameter IN value to the routine
     */
    fun set__2(value: Int?): Unit = setValue(Subpath2._2, value)
